...
data_dir <- "C:/Users/User/Desktop/Data Science/Home Price Index Trends in Canada after COVID-19/New Condo Price Data (Cleaned).csv"
...
for (i in 1:length(locations)){
  ...
  ggsave(path="C:/Users/User/Desktop/Data Science/Home Price Index Trends in Canada after COVID-19", filename=paste(locations[i],".png"), width=10, height=5)
}
...
write.csv(results,"C:/Users/User/Desktop/Data Science/Home Price Index Trends in Canada after COVID-19/Price Trends.csv", row.names = TRUE)